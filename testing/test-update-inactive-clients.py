...
# tests the updating of client records from active to inactive if they are not in the latest fetch of connected clients
...
print("Updating any clients to inactive...")
db.detectInactiveClients()
print("Done.")